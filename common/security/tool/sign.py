...
class Sign(object):
    ...
    def gen_cert2(self):
        ...
        if is_img_hash_list:
            ...
            self.gen_img_hash_list(img_file, cert1, cert_privk, img_name, img_ver, socid)
            return
    ...
    def gen_img_hash_list(self, img_file, cert1, cert_privk, img_name, img_ver, socid):
        """
        ...
        fill_cert_config(cert2_config_out, str(img_size), CERT2_REPLACE_IMGSIZE)
        fill_cert_config(cert2_config_out, socid.upper(), CERT2_REPLACE_SOCID)
        if int(img_ver) != 0:
            fill_cert_config(cert2_config_out, img_ver, IMG_VER_REPLACE_TARGET)
        #gen cert2
